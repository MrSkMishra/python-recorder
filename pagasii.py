...
img1 = Image.open('IMG_20230101_162221.jpg')
enhancer = ImageEnhance.Contrast(img1)
enhancer_bright = ImageEnhance.Brightness(img1)
enhancer_color = ImageEnhance.Color(img1)
enhancer_color.enhance(1.7)
enhancer_bright.enhance(1.4)
enhancer.enhance(1.3).save('pagalsii.jpg')
...
# image = Image.open('IMG_20230101_162221.jpg')
